...
CREATE DATABASE IF NOT EXISTS students_db_35
CHARACTER SET utf8 
COLLATE utf8_unicode_ci;

/*Crear usuario de la base de datos*/
CREATE USER 'students_user_35'@'localhost' IDENTIFIED BY '12345';

/*Otorgar todos los permisos sobre la base de datos*/
GRANT ALL PRIVILEGES ON students_db_35.* TO 'students_user_35'@'localhost';
...
O PARA MAYOR SEGURIDAD CON EL USUARIO students_user_35****************************/
...
/*REVOKE ALL PRIVILEGES, GRANT OPTION FROM 'students_user_35'@'localhost';
DROP USER 'students_user_35'@'localhost';
DROP DATABASE students_db_35;*/